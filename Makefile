...
build/secp256r1_blake160_sighash_lay2dev_all: c/secp256r1_blake160_sighash_lay2dev_all.c c/common.h libecc-optimized
	$(CC) $(CFLAGS) $(CFLAGS_LINK_TO_LIBECC_OPTIMIZED) $(LDFLAGS) -o $@ c/secp256r1_blake160_sighash_lay2dev_all.c c/common.h ${LIBECC_OPTIMIZED_FILES}
	$(OBJCOPY) --only-keep-debug $@ $@.debug
	$(OBJCOPY) --strip-debug --strip-all $@ $@.stripped
